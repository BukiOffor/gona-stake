...
// cargo run -- --node http://node.testnet.concordium.com:20000 --account ~/38TN6fTCjgHYp7vXDagLJsb6s3UHzDANaGS2wXwgQLBUJrEian.export --module /Users/mac/gona-stake/dist/stake.wasm.v1
